    ...
    def train(self):
        ...
        for t in range(num_iterations):
            ...
            if self.verbose and t % self.print_every == 0:
                ...
                avg_time_per_iteration = elapsed_time / iterations_done
                estimated_time_remaining = avg_time_per_iteration * iterations_left

                print(
                    f"(Iteration {iterations_done} / {num_iterations}) loss: {self.loss_history[-1]:.4f}, "
            ...
            if first_it or last_it or epoch_end:
                ...
                if self.verbose:
                    print(
                        f"(Epoch {self.epoch} / {self.num_epochs}) train acc: {train_acc:.4f}; val_acc: {val_acc:.4f}"
                    )
